...
function CVButton() {
  return (
    <Link
      ...
      target="_blank"
    >
      <div className="group flex rounded-full bg-white/90 px-3 py-2 text-sm shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur transition  hover:text-orange-500 dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 dark:hover:text-orange-400 dark:hover:ring-white/20">
        CV
        <ArrowTopRightOnSquareIcon className="ml-2 h-6 w-6 stroke-zinc-600 p-0.5 transition group-hover:stroke-orange-500 dark:block dark:stroke-zinc-400" />
      </div>
    </Link>
  )
}
